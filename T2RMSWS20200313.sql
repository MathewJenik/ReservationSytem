...
/****** Highlight this step and run first, you can delete then run the whole scrip from CREATE database ******/
USE master ;  
GO  
DROP DATABASE [T2RMSWS] ;  
GO  

/**DELETE ABOVE BEFORE YOU RUN THE BELOW**/
...
USE [T2RMSWS];
GO
/****** Object:  Table [dbo].[__EFMigrationsHistory]    Script Date: 13/03/2020 1:24:34 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[AspNetRoleClaims]    Script Date: 13/03/2020 1:24:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AspNetRoles]    Script Date: 13/03/2020 1:24:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AspNetUserClaims]    Script Date: 13/03/2020 1:24:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AspNetUserLogins]    Script Date: 13/03/2020 1:24:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AspNetUserRoles]    Script Date: 13/03/2020 1:24:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AspNetUsers]    Script Date: 13/03/2020 1:24:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AspNetUserTokens]    Script Date: 13/03/2020 1:24:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[People]    Script Date: 13/03/2020 1:24:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Restaurants]    Script Date: 13/03/2020 1:24:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Sittings]    Script Date: 13/03/2020 1:24:34 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[People] ([Id], [Age], [RestaurantId], [FirstName]) VALUES (N'361ba8c7-3f97-447f-9fcb-74a7c1942067', 21, 1, NULL)
INSERT [dbo].[People] ([Id], [Age], [RestaurantId], [FirstName]) VALUES (N'b00dc7ae-30ea-43c6-8f87-20071a95decb', 10, 1, NULL)
INSERT [dbo].[People] ([Id], [Age], [RestaurantId], [FirstName]) VALUES (N'cdd84d3e-d69b-4b2e-bac2-58eb40632417', 1001, 1, NULL)
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IX_AspNetRoleClaims_RoleId]    Script Date: 13/03/2020 1:24:49 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [RoleNameIndex]    Script Date: 13/03/2020 1:24:49 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IX_AspNetUserClaims_UserId]    Script Date: 13/03/2020 1:24:49 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IX_AspNetUserLogins_UserId]    Script Date: 13/03/2020 1:24:49 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IX_AspNetUserRoles_RoleId]    Script Date: 13/03/2020 1:24:49 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [EmailIndex]    Script Date: 13/03/2020 1:24:49 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UserNameIndex]    Script Date: 13/03/2020 1:24:49 PM ******/
...
WITH (STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF) ON [PRIMARY]
GO
/****** Object:  Index [IX_People_RestaurantId]    Script Date: 13/03/2020 1:24:49 PM ******/
CREATE NONCLUSTERED INDEX [IX_People_RestaurantId] ON [dbo].[People]
(
	[RestaurantId] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, DROP_EXISTING = OFF, ONLINE = OFF) ON [PRIMARY]
GO
/****** Object:  Index [IX_Sittings_RestaurantId]    Script Date: 13/03/2020 1:24:49 PM ******/
